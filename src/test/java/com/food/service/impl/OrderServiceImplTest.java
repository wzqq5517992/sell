...
public class OrderServiceImplTest {
    ...
    public void findOne() throws Exception {
        OrderDTO result = orderService.findOne("1557286996761970840");
        log.info("【查询单个订单】result={}", result);
        Assert.assertEquals("1557286996761970840", result.getOrderId());
    }
    ...
    public void cancel() throws Exception {
        OrderDTO orderDTO = orderService.findOne("1557286996761970840");
